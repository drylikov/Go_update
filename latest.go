...
import (
	...
	"github.com/drylikov/go-update"
	"github.com/drylikov/go-update/progress"
	"github.com/drylikov/go-update/stores/github"
)
...
func main() {
	...
	// update polls(1) from drylikov/gh-polls on github
	m := &update.Manager{
		Command: "polls",
		Store: &github.Store{
			Owner:   "drylikov",
